(function() {
    ...
    */
    ...
    var X = decodeURI("%73cript"),
        ...
        Ja = function() {
            var a = K.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(Ha) ? a : K.nonce = null : G.querySelector ? (a = G.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Ha) ? K.nonce = a : K.nonce = null) : null : null
        },
        La = function(a) {
    ...
    var Ma = function(a, b) {
        if (K.hee && 0 < K.hel) try {
            ...
            b && b(c), K.hel--, Pa("debug_error", function() {
                try {
